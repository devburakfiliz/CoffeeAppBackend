...
namespace ServiceReference12
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="ServiceReference12.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        ServiceReference12.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(ServiceReference12.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceReference12.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(ServiceReference12.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public ServiceReference12.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(ServiceReference12.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public ServiceReference12.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(ServiceReference12.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface KPSPublicSoapChannel : ServiceReference12.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<ServiceReference12.KPSPublicSoap>, ServiceReference12.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServiceReference12.TCKimlikNoDogrulaResponse ServiceReference12.KPSPublicSoap.TCKimlikNoDogrula(ServiceReference12.TCKimlikNoDogrulaRequest request)
        {
        ...
        {
            ServiceReference12.TCKimlikNoDogrulaRequest inValue = new ServiceReference12.TCKimlikNoDogrulaRequest();
            inValue.Body = new ServiceReference12.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            ServiceReference12.TCKimlikNoDogrulaResponse retVal = ((ServiceReference12.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference12.TCKimlikNoDogrulaResponse> ServiceReference12.KPSPublicSoap.TCKimlikNoDogrulaAsync(ServiceReference12.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference12.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            ServiceReference12.TCKimlikNoDogrulaRequest inValue = new ServiceReference12.TCKimlikNoDogrulaRequest();
            inValue.Body = new ServiceReference12.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            ...
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((ServiceReference12.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
